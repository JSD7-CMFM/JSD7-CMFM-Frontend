...
// const ProductListBySeries = {};

// ProductList.forEach((product) => {
//   if (!ProductListBySeries[product.series]) {
//     ProductListBySeries[product.series] = [];
//   }
//   ProductListBySeries[product.series].push(product);
// });

// return (
//   <div>
//     {Object.keys(ProductListBySeries).map((series) => (
//       <div key={series}>
//         <h2>{series}</h2>
//         <div className="flex flex-wrap">
//           {ProductListBySeries[series].map((product) => (
//             <div
//               key={product.id}
//               className="border rounded-md m-3 border-gray-600"
//             >
